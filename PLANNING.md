...
| 2026-08-29 | Ship `v2.1.2` map overlay and zoom chrome (Add PDF beside the title; Leaflet zoom under the white bar) plus line EMT/paramedic and compact board header from the prior commit | Keep the ops map usable without covering controls | Builder (user) | v2.1.1 columns/Map points; overlay still stacked with zoom on top of the bar |
